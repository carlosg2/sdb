...
<div class="grid grid-cols-3  grid-flow-row gap-4 h-screen">

  <div  class="h-screen" style="background-image: url(../assets/images/background.jpg);">
    <div class=" bg-base-100 opacity-60"></div>
    <div class="hero-content text-center text-neutral-content">
      <div class="max-w-md pt-14 pb-6 text-base-content space-y-2">
        ...
        <div class=" space-x-2">
          ...
          <a href="https://goo.gl/maps/PLMEXws8pXRTTq6D9" rel="external" target="_blank" class="btn btn-ghost border-base-content/20 btn-circle">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
  ...
  <div class="h-screen  " >
    <div class="flex flex-col  max-w-screen-lg mx-auto flex-nowrap text-sm font-bold overflow-x-auto  px-4 py-3 md:py-4 no-scrollbar ">
