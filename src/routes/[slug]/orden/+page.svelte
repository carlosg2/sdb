        ...
        <div
          ...
          <div class="lg:pl-10">
            <div class="mb-10 pb-10 border-b border-base-300 border-b-[0.5px]">
              ...
              <h2
                class="mt-2 mb-4 max-w-xl text-3xl md:text-4xl font-bold font-display">
                {selected.title}
              </h2>
            ...
            <div class="my-4">
              ...
              <div class="mt-10">
                ...
                <div class="mt-4 grid grid-cols-2 gap-4">
                  <div class="relative">
                    ...
                    <label
                      class="block p-4 text-sm font-medium border border-base-300 rounded-box cursor-pointer peer-checked:border-blue-500 hover:bg-base-100 peer-checked:bg-base-100 peer-checked:ring-1 peer-checked:ring-blue-500"
                      for="standard_alt">
                      <span> 2 Purés </span>
              ...
              <div class="modal-action ">
                <div
                  class="inline-flex items-center px-4 font-semibold font-heading text-primary-content border border-base-300 focus:ring-blue-300 focus:border-blue-300 rounded-box">
                  ...
                  <input
                    class="input input-ghost w-20 m-0 px-4 py-4 text-center md:text-right border-0 focus:ring-transparent focus:outline-none rounded-box"
                    type="number"
                    placeholder="1" />
                  <button class="py-2 hover:text-gray-700">
                    <svg
...
<div
  ...
  <div class="hero-content text-center text-neutral-content">
    <div class="max-w-md pt-14 pb-6 text-base-content space-y-2">
      ...
      <div class=" space-x-2">
        <a
          href="tel:+528122612939"
          class="btn btn-ghost border-base-content/20 btn-circle">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
            fill="currentColor"
        ...
        <a
          href="https://www.google.com/maps/search/?api=1&query={tienda.coordenadas}"
          rel="external"
          target="_blank"
          class="btn btn-ghost border-base-content/20 btn-circle">
          <svg
