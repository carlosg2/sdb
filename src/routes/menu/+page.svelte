...
<ul class="divide-y-[.5px] pt-20 divide-base-300 ">
  ...
  <li class="text-base-content  bg-base-200 z-10 pr-4 pl-4 w-full items-start pb-4 pt-8 select-none" >
  ...
  <li class="text-base-content pr-4 flex items-start select-none" >
